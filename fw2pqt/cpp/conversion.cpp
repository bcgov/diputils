...
int main(int argc, char** argv) {
  ...
  std::shared_ptr<arrow::Table> table;
  EXIT_ON_FAILURE(VectorToColumnarTable(rows, &table)); // convert vector to columnar table

  std::vector<data_row> expected_rows;
  EXIT_ON_FAILURE(ColumnarTableToVector(table, &expected_rows)); // convert columnar table to vector
